...
// Character analysis function - ENHANCED
async function analyzeCharactersWithClaude(text) {
  ...
  try {
    ...
    const response = await anthropic.messages.create({
      model: "claude-3-haiku-20240307",
      max_tokens: 1500, // Increased for more detailed character analysis
      system: `Identify and thoroughly analyze all characters in this story.
      
      For each character, determine:
      - Their role in the story (protagonist, antagonist, supporting character, etc.)
      - Key personality traits and attributes based on their actions and dialogue
      - How consistently they are portrayed throughout the text
      - Their development or character arc if present
        ...
        "characters": [
          {
            ...
            "traits": "description of key personality traits and attributes",
            "consistency": "High/Medium/Low",
            "development": "description of any character development or arc",
            "dialogueStyle": "description of how the character speaks if applicable"
          }
        ],
        "score": 0-100 score for overall character development quality,
        "strengths": "aspects of character development done well",
        "weaknesses": "aspects that could be improved",
        "suggestions": "specific suggestions for improving character development"
      }
...
// AI detection function - ENHANCED
async function detectAIContentWithClaude(text) {
  ...
  try {
    ...
    // Updated to use more detailed instructions
    const response = await anthropic.messages.create({
      model: "claude-3-haiku-20240307",
      ...
      - Use of common AI phrasings or structures
      ...
      
      {
        ...
        "reasoning": "detailed explanation of why you believe the text is or isn't AI-generated, including specific examples from the text",
        "confidence": 0-1 confidence value,
        "key_indicators": ["list of specific phrases or patterns that influenced your decision"]
      }
